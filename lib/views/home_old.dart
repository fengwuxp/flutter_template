  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        ...
        child: Scaffold(
          ...
          body: Router(
            key: _routerKey,
            route: activeBottomNavigationBar.toString(),
            onUnknownRoute: globalSettings.routerSettings.onUnknownRoute,
            routes: {
              '0': (context) => SingleChildScrollView(
                    child: Home(),
                  ),
              '1': (context) => Home(),
              '2': (context) => Home(),
          ...
          floatingActionButton: activeBottomNavigationBar==0?FloatingActionButton(
